        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Soname = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpacificProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpacificProducts_Products_Product_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Region = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ZIP = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
                    Deparment_Id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecificProduct_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sales_SpacificProducts_SpecificProduct_Id",
                        column: x => x.SpecificProduct_Id,
                        principalTable: "SpacificProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sales_Tickets_Ticket_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_SpecificProduct_Id",
                table: "Sales",
                column: "SpecificProduct_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Sales_Ticket_Id",
                table: "Sales",
                column: "Ticket_Id");

            migrationBuilder.CreateIndex(
                name: "IX_SpacificProducts_Product_Id",
                table: "SpacificProducts",
                column: "Product_Id");
